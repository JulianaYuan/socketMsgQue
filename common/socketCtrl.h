 /**
 * @file WifiWpasCtrl.h
 * @brief This file is used define the if of wpa_supplicant.
 */

#ifndef WIFI_WPAS_CTRL_H
#define WIFI_WPAS_CTRL_H
...
/** event**/
/***************************************/
#define SCAN_RESULTS_HEAD "bssid / frequency / signal level / flags / ssid"

#define WPA_EVENT_ASSOCIATED "Associated with"

#define WPA_EVENT_ASSOCIATING "Trying to associate with SSID"

#define WPA_EVENT_ASSOCIATION_TMO  "Authentication with 00:00:00:00:00:00 timed out"

#define WPA_EVENT_WPSCOMPLETE "WPA: Key negotiation"

#define WPA_EVENT_4WAY_HANDSHAKE_FAILED "WPA: 4-Way Handshake failed - pre-shared key may be incorrect"
/***************************************/
/**following event defined by wpa_supplicant(bcm's source)**/
/***************************************/
